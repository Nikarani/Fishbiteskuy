...
public class IkanLautActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kategori_ikan_laut);
        ...
        productList.add(new Product("Ikan Salmon", 70000, R.drawable.ikan_salmon));
        productList.add(new Product("Ikan Tuna", 90000, R.drawable.ikan_tuna));
